...
public class GlobalExceptionHandler {
    ...
    public ProblemDetail handleUnauthorizedConversation(UnauthorizedConversationException ex) {
        log.error("Unauthorized conversation access: {}", ex.getMessage());
        ProblemDetail detail = ProblemDetail.forStatusAndDetail(HttpStatus.FORBIDDEN, ex.getMessage());
        detail.setType(URI.create(ApiConstants.PROBLEM_DETAIL_TYPE));
        detail.setTitle(ApiConstants.PROBLEM_DETAIL_TITLE_FORBIDDEN);
        return detail;
    }
